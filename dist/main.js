...
var SettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName(i18n.t("toggleMouseShortcuts")).setDesc(i18n.t("toggleMouseShortcutsDes")).addDropdown((component) => {
      component.addOption("2", i18n.t("doubleClick")).addOption("3", i18n.t("tripleClick")).addOption("-1", i18n.t("noClick")).setValue(this.plugin.settings.consecutiveClickTimes.toString()).onChange(async (value) => {
